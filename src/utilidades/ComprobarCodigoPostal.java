...
public class ComprobarCodigoPostal {
    ...
    public static void verificarCodigoPostal(String codigoPostal, String provincia) throws CodigoPostalException{
        ...
        provincias.put("10", "Caceres");
        provincias.put("11", "Cadiz");
        provincias.put("12", "Castellon");
        provincias.put("13", "Ciudad Real");
        provincias.put("14", "Cordoba");
        provincias.put("15", "La Coruña");
        provincias.put("16", "Cuenca");
        provincias.put("17", "Gerona");
        ...
        provincias.put("24", "Leon");
        provincias.put("25", "Lerida");
        provincias.put("26", "Lugo");
